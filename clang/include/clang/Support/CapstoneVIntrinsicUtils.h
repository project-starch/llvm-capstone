//===--- CapstoneVIntrinsicUtils.h - Capstone Vector Intrinsic Utils -*- C++ -*-===//
//
...
#ifndef CLANG_SUPPORT_CapstoneVINTRINSICUTILS_H
#define CLANG_SUPPORT_CapstoneVINTRINSICUTILS_H
...
#endif // CLANG_SUPPORT_CapstoneVINTRINSICUTILS_H
