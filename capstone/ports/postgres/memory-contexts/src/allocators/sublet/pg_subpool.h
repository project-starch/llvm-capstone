 ...
 *
 * Delegation is per context. The sub-pool table, block table and context
 * header live outside the delegated region: revocation cannot spare part
 * of the region it covers.
 *
...
/* Default region size for an AllocSet context; larger contexts add pools. */
 ...
 * by the very reset it is executing.
 *
