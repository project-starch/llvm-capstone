...
if(PG_MEMORY_PROFILE)
  ...
  target_include_directories(replay-options INTERFACE "${PROJECT_SOURCE_DIR}/memory-profile")
endif()
...
if(PG_PLATFORM STREQUAL "native")
  ...
  if(PG_MEMORY_PROFILE)
    ...
    target_sources(replay-spatial PRIVATE memory-profile/profile.c)
    target_sources(replay-sublet PRIVATE memory-profile/profile.c)
  endif()
