...
if(PG_MEMORY_PROFILE)
  if(NOT PG_PLATFORM STREQUAL "capstone-domain")
  ...
  target_include_directories(replay-options INTERFACE "${PROJECT_SOURCE_DIR}/memory-profile/capstone-domain")
endif()
...
if(PG_PLATFORM STREQUAL "native")
  ...
  if(PG_MEMORY_PROFILE)
    ...
    target_sources(replay-spatial PRIVATE memory-profile/capstone-domain/profile.c)
    target_sources(replay-sublet PRIVATE memory-profile/capstone-domain/profile.c)
  endif()
