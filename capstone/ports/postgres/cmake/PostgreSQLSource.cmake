# The same release as the recorded pgbench workloads. No upstream source is
# committed: configure verifies the archive, prepares headers, and applies
# the ABI and allocator patches to separate build-local variants.
set(PG_VERSION 17.5)
set(PG_SHA256 fcb7ab38e23b264d1902cb25e6adafb4525a6ebcbd015434aeef9eda80f528d8)
pg_path(PG_ARCHIVE "${PG_WORK}/download/postgresql-${PG_VERSION}.tar.bz2" "Pinned PostgreSQL archive")
