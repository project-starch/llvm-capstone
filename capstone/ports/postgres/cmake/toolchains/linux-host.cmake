...
set(PG_PLATFORM linux-host CACHE STRING "Execution platform" FORCE)
include("${CMAKE_CURRENT_LIST_DIR}/../Workspace.cmake")
get_filename_component(repo "${CMAKE_CURRENT_LIST_DIR}/../../../../.." ABSOLUTE)
pg_path(CAPSTONE_BUILDROOT_DIR "${repo}/capstone/caplifive-buildroot" "Guest Linux toolchain and libcapstone")
