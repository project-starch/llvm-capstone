/* Freestanding stand-in for <stdio.h>: the domain gets its libc from capstone_sqlite_libc.h,
 * force-included before every translation unit. Without this file the driver falls through to
 * the host's /usr/include, whose stdio.h pulls glibc's features.h and, on Debian-layout hosts,
