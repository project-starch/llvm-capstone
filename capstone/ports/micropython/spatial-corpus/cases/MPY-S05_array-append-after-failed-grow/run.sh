...
PATCH=$(git rev-parse --show-toplevel)/capstone/ports/micropython/spatial-corpus/cases/MPY-S05_array-append-after-failed-grow/revert-the-fix.patch
...
repro_scripts capstone/ports/micropython/spatial-corpus/cases/MPY-S05_array-append-after-failed-grow mpy_s05
