...
| [`pools/`](pools/README.md) | the **port** that grew out of it: the same allocator in a Capstone domain with a Sublet adapter, and on stock CheriBSD against the platform's own `malloc`, for the [httpd/APR bug corpus](../../bug-corpora/httpd/apr-pool-repros/README.md) |
