...
# - one descriptor-driven materialization POC,
...
bash "$SCRIPT_DIR/build-domain.sh" \
  "$PROBE_DIR/descriptor_materialize_domain.c" \
  "$OUT_DIR/static_cap_globals_descriptor_materialize.dom"
...
"$LLVM_READOBJ" -h "$OUT_DIR/static_cap_globals_descriptor_materialize.dom"
...
echo "Built $OUT_DIR/static_cap_globals_descriptor_materialize.dom"
