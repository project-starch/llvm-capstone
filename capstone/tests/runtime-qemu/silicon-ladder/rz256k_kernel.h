 ...
 * rz256k: ONE global plus 256 KB of inert .rodata padding => the image
 * grows to ~256 KB while the carve count stays at 1. Isolates IMAGE SIZE.
...
static unsigned rz256k_compute(void)
{
