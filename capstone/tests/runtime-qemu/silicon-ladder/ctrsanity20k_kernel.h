#ifndef CTRSANITY20K_KERNEL_H
#define CTRSANITY20K_KERNEL_H
/* The ctrsanity kernel at N=4000 (~20,000 instructions): one point of the phase-6 length
