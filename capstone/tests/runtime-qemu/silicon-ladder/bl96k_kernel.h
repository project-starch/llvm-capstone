...
char bl96k_arr[98304] = { 1 };
static char bl96k_g[2] = { 9, 0 };
static unsigned bl96k_compute(void)
{
  bl96k_arr[0] = 1; bl96k_arr[98303] = 1;
  return (unsigned)(unsigned char)bl96k_g[0]
       + (unsigned)(unsigned char)bl96k_arr[0] - 1u;
}
#endif
