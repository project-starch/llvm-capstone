...
#     --extended         also run the setup-heavier suites (postgres/micropython/
#                        sqlite/hostcall/nullblk)
...
EXTENDED_SUITES=(
  ...
  # micropython is the fourth application gate, and it is here rather than in
