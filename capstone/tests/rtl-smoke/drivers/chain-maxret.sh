...
#   boot 1 COMPLETES -> banks BOTH remaining Design arms: pressure covering 43,296/65,532 = 66.07 % of
#                       the pool, and release at C = 4,329 reaching phase 2 for the first time on
