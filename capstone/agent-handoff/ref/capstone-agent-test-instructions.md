...
`592 PASS / 93 FAIL / 0 FAULT / 0 HANG / 232 UNSCORED` for the 917 standard files and
`619 PASS / 244 FAIL / 0 FAULT / 0 HANG / 254 UNSCORED` across all 1,117 direct files. Use
