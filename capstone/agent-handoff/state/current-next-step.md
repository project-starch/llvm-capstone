...
conversion formed `dig + len`. Any next MicroPython follow-up should classify the 500 ordinary
FAIL and 14 UNSCORED cases by missing feature or harness requirement, not repair tests individually
