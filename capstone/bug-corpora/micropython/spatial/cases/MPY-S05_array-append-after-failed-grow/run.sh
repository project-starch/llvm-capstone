...
source "$(git rev-parse --show-toplevel)/capstone/bug-corpora/micropython/repro-lib.sh"
...
PATCH=$(git rev-parse --show-toplevel)/capstone/bug-corpora/micropython/spatial/cases/MPY-S05_array-append-after-failed-grow/revert-the-fix.patch
...
repro_scripts capstone/bug-corpora/micropython/spatial/cases/MPY-S05_array-append-after-failed-grow mpy_s05
