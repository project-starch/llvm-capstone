...
- **Fix:** `de07c57d5a` — *"avfilter/avf_ahistogram: make frame writable before writing to it"*, 2022-03-04. One line: `av_frame_make_writable(s->out);`.
- **File:** `libavfilter/avf_ahistogram.c`.
- **CVE:** `NO VERIFIED CVE`.
