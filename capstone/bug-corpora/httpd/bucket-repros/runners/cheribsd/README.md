...
a pool it destroyed.
    ...
    BUILD=/tmp/capstone/bucket-repros/cheribsd
    bash capstone/bug-corpora/httpd/bucket-repros/shared/build-cases.sh cheribsd "$BUILD"

    python3 capstone/bug-corpora/httpd/bucket-repros/runners/cheribsd/run-defects.py \
