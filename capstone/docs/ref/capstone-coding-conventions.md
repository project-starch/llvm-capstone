...
- top-level `capstone/` paths that are **not** child repositories (`capstone/tests/`, `capstone/utils/`, `capstone/docs/`, `capstone/my_first_domain/`) -> use the explicit workspace-layer convention defined below.
