...
- Issue and full evidence: `capstone/docs/ref/ISSUES.md`, entry **R-18**
- Handover package incl. simulation tests: `capstone/tests/fpga-repros/R18-scalar-store-metadata-clobber/`
- Trail with every retraction: `capstone/docs/history/07-08-2026_23-55-00_r18-localized-to-row-mate-traffic.md`
