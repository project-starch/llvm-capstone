...
## Shared-file hazards inside `docs/`
...
- **Memory dir** (`~/.claude/projects/<path-hash>/memory/` + `MEMORY.md`) is keyed
  ...
  write it into a committed doc (`docs/…`), not only into memory.
...
Keep a committed, frequently-updated `capstone/docs/COORDINATION.md` that
