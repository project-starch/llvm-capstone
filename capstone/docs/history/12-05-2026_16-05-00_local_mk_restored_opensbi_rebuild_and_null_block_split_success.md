...
```bash
cd <REPO-ROOT>/capstone/caplifive-buildroot
make build CAPSTONE_CC_PATH=<REPO-ROOT>/capstone/capstone-c A=opensbi-rebuild
```
...
>>> opensbi custom Syncing from source dir <REPO-ROOT>/capstone/caplifive-buildroot/components/opensbi
```
