...
- `capstone/docs/new-chat-prompt.md`
- `capstone/docs/current/capstone-agent-test-instructions.md`
- `capstone/docs/current/testing-matrix.md`
- `capstone/docs/current/current-next-step.md`
- `capstone/docs/current/split-host-enclave-strategy.md`
- `capstone/docs/current/runtime-terms-glossary.md`
