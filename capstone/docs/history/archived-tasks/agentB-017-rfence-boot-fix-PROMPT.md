...
You are Agent-B, continuing task 017 in `<REPO-ROOT-B>`,
branch `capstone-bootstrap-b`.

```bash
cd <REPO-ROOT-B> && git fetch origin && git pull --rebase
...
- History note → `capstone/docs/history/DD-MM-YYYY_HH-MM-SS_fpga-rfence-boot-fix.md`.
