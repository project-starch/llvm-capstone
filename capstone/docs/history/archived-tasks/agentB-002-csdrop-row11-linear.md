...
*Hand this whole file to Agent-B (`claude-b`), clone `<REPO-ROOT-B>`,
...
`capstone/docs/{MULTI-AGENT-WORKFLOW,COORDINATION}.md`.

## Why this task

Two Stage-2 corpus rows are deferred as "blocked intra-domain"
(`capstone/docs/history/08-07-2026_13-01-23_linear-uninit-rows-blocked-intra-domain.md`).
