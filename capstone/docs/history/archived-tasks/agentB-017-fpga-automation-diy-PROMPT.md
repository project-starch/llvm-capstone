...
`capstone/docs/tasks/agentB-017-fpga-automation-diy.md` — this prompt
...
your clone `<REPO-ROOT-B>`, branch `capstone-bootstrap-b`.
...
Read, in order: `./CLAUDE.md`, `capstone/docs/README.md`,
`capstone/docs/state/current-state.md` (the "Latest (2026-07-15)"
banner), and your task brief
`capstone/docs/tasks/agentB-017-fpga-automation-diy.md`.
...
- History trail → `capstone/docs/history/DD-MM-YYYY_HH-MM-SS_fpga-automation-diy.md`.
