# Superseded layers split out of `state/current-next-step.md` (2026-09-04)

`state/current-next-step.md` had reached 1,558 lines. A next step is not 1,558 lines — the file
had become a stack of every "CURRENT" block written since early August, each superseded by the one
above it, several of them still carrying the heading `## 0. CURRENT`.

**Nothing here was deleted or edited.** These are the superseded layers, verbatim, newest first.
They are worth keeping: most of them record a hypothesis that was live at the time and was later
refuted, and the refutation is only legible next to what was believed.

For the actual next step, read `state/current-next-step.md`.

---

## 0a. SUPERSEDED — 2026-08-29. S-12's evidence base was re-audited and MOST OF IT MOVED. Instruments first.
...
> `capstone/docs/ref/SILICON-BLOCKER.md` — everything known, with every claim tagged
...
Full trail: `capstone/docs/ref/SILICON-BLOCKER.md`, 2026-08-04 and 2026-08-05 sections.
