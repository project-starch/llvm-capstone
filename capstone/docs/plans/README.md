...
This directory holds work-in-progress plans for ongoing Capstone development.
...
Regenerated 2026-08-18. The previous table listed 3 of 38 files and had not been touched since
2026-06-18, so it was worse than no index: it implied the other 35 did not exist.

**Archived plans** — one-shot task prompts and superseded plans — moved to `plans/archived/`
on 2026-08-18. They are kept, not deleted, because several record measured results.
...
| `ndss-pivot-master-plan.md` | 2026-07-24 |
| `perf-cheri-vs-capstone-qemu.md` | 2026-07-21 |
| `proposal-blocker-investigation-skill.md` | 2026-08-03 |
| `sqlite-capstone-cve-corpus-plan.md` | 2026-07-20 |
