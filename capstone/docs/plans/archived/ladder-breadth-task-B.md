...
**`capstone/docs/history/29-07-2026_ARCHIVED_DELEGATION-lane-a-b.md`**, and treat their hard constraints — plus
...
`docs/state/current-state.md` for the live picture.
