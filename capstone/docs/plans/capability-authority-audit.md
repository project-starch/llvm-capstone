...
- `capstone/docs/ref/capstone-purecap-pointer-model.md`
...
- capstone/docs/ref/capstone-purecap-pointer-model.md
- capstone/docs/plans/capability-authority-audit.md
...
Update capstone/docs/plans/capability-authority-audit.md with what was
