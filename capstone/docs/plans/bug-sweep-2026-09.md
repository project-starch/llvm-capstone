...
- Pending, infrastructure-blocked: the S-04 -O1 arm boot (image `sqm0o1` b4b453f90cd7edb4 baked in the board overlay; `retry-s04.sh` probes the console until ~18:08 and boots it as sw22 if the host resolves — any such reading is unreviewed and needs a batch-5 line or a rerun).
