...
Validation chain on the S-12-removed compiler (lib 50818be7cbe6, 14:43–14:45): Capstone lit CodeGen 89, MC 11, MC/Disassembler 2 — all pass; RISCV 2257 tests, 2 failures (`emutls.ll`, `rvv/debug-info-rvv-dbg-value.mir`) = the recorded pre-existing debug-info/emutls class, no new failure; coverage gate 0 gaps; byte identity of the S-12 removal: a gp-captable rung (beebs_crc32 -O2) and two default-ABI objects (cap-control-flow -O2, intrinsics -O0) IDENTICAL before and after the deletion.
