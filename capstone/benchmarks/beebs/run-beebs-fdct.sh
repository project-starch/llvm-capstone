...
python3 "$CAPSTONE_REPO_ROOT/capstone/tests/runtime-qemu/run-domain-smoke.py" \
  ...
  --guest-command \
    'cp /mnt/host/beebs_fdct_host.user /tmp/beebs_fdct_host.user && chmod 0755 /tmp/beebs_fdct_host.user && /tmp/beebs_fdct_host.user /mnt/host/beebs_fdct_capstone.dom' \
