...
python3 "$CAPSTONE_REPO_ROOT/capstone/tests/runtime-qemu/run-domain-smoke.py" \
  ...
  --guest-command \
    'cp /mnt/host/beebs_duff_host.user /tmp/beebs_duff_host.user && chmod 0755 /tmp/beebs_duff_host.user && /tmp/beebs_duff_host.user duff /mnt/host/beebs_duff_capstone.dom' \
