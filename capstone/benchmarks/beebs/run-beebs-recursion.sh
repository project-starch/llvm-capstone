...
python3 "$CAPSTONE_REPO_ROOT/capstone/tests/runtime-qemu/run-domain-smoke.py" \
  ...
  --guest-command \
    'cp /mnt/host/beebs_recursion_host.user /tmp/beebs_recursion_host.user && chmod 0755 /tmp/beebs_recursion_host.user && /tmp/beebs_recursion_host.user /mnt/host/beebs_recursion_capstone.dom' \
