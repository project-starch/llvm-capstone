...
python3 "$CAPSTONE_REPO_ROOT/capstone/tests/runtime-qemu/run-domain-smoke.py" \
  ...
  --guest-command \
    'cp /mnt/host/beebs_cover_host.user /tmp/beebs_cover_host.user && chmod 0755 /tmp/beebs_cover_host.user && /tmp/beebs_cover_host.user cover /mnt/host/beebs_cover_capstone.dom' \
