...
ADAPTED_JANNE_COMPLEX_SRC=$SCRIPT_DIR/adapted/beebs_janne_complex_capstone.c
...
if [[ ! -f "$ADAPTED_JANNE_COMPLEX_SRC" ]]; then
  echo "missing adapted janne_complex source: $ADAPTED_JANNE_COMPLEX_SRC" >&2
  exit 1
fi
