...
ADAPTED_BUBBLESORT_SRC=$SCRIPT_DIR/adapted/beebs_bubblesort_capstone.c
...
if [[ ! -f "$ADAPTED_BUBBLESORT_SRC" ]]; then
  echo "missing adapted bubblesort source: $ADAPTED_BUBBLESORT_SRC" >&2
  exit 1
fi
