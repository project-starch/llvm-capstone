...
ADAPTED_LEVENSHTEIN_SRC=$SCRIPT_DIR/adapted/beebs_levenshtein_capstone.c
...
if [[ ! -f "$ADAPTED_LEVENSHTEIN_SRC" ]]; then
  echo "missing adapted levenshtein source: $ADAPTED_LEVENSHTEIN_SRC" >&2
  exit 1
fi
