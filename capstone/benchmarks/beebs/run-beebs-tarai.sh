...
python3 "$CAPSTONE_REPO_ROOT/capstone/tests/runtime-qemu/run-domain-smoke.py" \
  ...
  --guest-command \
    'cp /mnt/host/beebs_tarai_host.user /tmp/beebs_tarai_host.user && chmod 0755 /tmp/beebs_tarai_host.user && /tmp/beebs_tarai_host.user tarai /mnt/host/beebs_tarai_capstone.dom' \
