 ...
 * the allocator's.
 *
 * IT WAS DEAD. The mruby build has passed -DCAPSTONE_HEAP_NO_NARROW since the arm was
 * first used, and nothing ever read it -- the macro appeared exactly once in the whole
