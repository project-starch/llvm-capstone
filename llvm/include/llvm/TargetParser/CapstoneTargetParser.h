//===-- CapstoneTargetParser - Parser for target features ----------*- C++ -*-===//
//
...
#ifndef LLVM_TARGETPARSER_CAPSTONETARGETPARSER_H
#define LLVM_TARGETPARSER_CAPSTONETARGETPARSER_H
...
static inline bool isValidXSfmmVType(unsigned VTypeI) {
  return (VTypeI & ~0x738) == 0 && CapstoneVType::hasXSfmmWiden(VTypeI) &&
         CapstoneVType::getSEW(VTypeI) * CapstoneVType::getXSfmmWiden(VTypeI) <= 64;
}
