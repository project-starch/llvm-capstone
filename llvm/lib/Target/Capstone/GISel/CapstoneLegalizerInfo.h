...
//===----------------------------------------------------------------------===//
/// \file
/// This file declares the targeting of the Machinelegalizer class for Capstone.
/// \todo This should be generated by TableGen.
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_Capstone_CapstoneMACHINELEGALIZER_H
#define LLVM_LIB_TARGET_Capstone_CapstoneMACHINELEGALIZER_H
...
class CapstoneLegalizerInfo : public LegalizerInfo {
  const CapstoneSubtarget &STI;
  const unsigned XLen;
  const LLT sXLen;

public:
  CapstoneLegalizerInfo(const CapstoneSubtarget &ST);
