...
#define DEBUG_TYPE "capstone-simple-cst-prop"
...
class CapstoneSimpleConstantPropagation : public FunctionPass {
public:
  // Used for the pass registry.
  static char ID;

  CapstoneSimpleConstantPropagation() : FunctionPass(ID) {
    // Technically we do not need to put this in the constructor.
    // Usually this call lives in the uber InitializeAllXXX.
    initializeCapstoneSimpleConstantPropagationPass(
...
char CapstoneSimpleConstantPropagation::ID = 0;

PreservedAnalyses
CapstoneSimpleConstantPropagationNewPass::run(Function &F,
...
// function.
INITIALIZE_PASS(/*passImplementationName=*/CapstoneSimpleConstantPropagation,
                /*commandLineArgName=*/DEBUG_TYPE,
                /*name=*/"Capstone simple constant propagation",
                /*isCFGOnly=*/false,
                /*isAnalysis=*/false)

Pass *llvm::createCapstoneSimpleConstantPropagationPassForLegacyPM() {
  return new CapstoneSimpleConstantPropagation();
}
