//===-- CapstoneISAUtils.cpp - Capstone ISA Utilities --------------------------===//
//
...
static unsigned singleLetterExtensionRank(char Ext) {
  ...
  size_t Pos = CapstoneISAUtils::AllStdExts.find(Ext);
  ...
  return 2 + CapstoneISAUtils::AllStdExts.size() + (Ext - 'a');
}
...
bool llvm::CapstoneISAUtils::compareExtension(const std::string &LHS,
