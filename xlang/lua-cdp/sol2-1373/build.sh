#!/usr/bin/env bash
# Build the sol2 #1373 harness with ASan against the shared Lua toolchain.
# sol2 is header-only; v3.5.0 builds on gcc 15 (v3.3.0 from the issue does not,
# and #1373 is an as-designed reference-semantics behaviour, version-stable).
set -euo pipefail
