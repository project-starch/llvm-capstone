...
# Export ASAN_OPTIONS to ignore leak checks since we are focusing on UAF aborts in mark_context_stack
...
# Observed: runs to completion, exit 0. Without ASan the stale stack-slot
# read lands on memory the allocator has not reused.
